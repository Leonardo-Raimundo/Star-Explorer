...
local function criar_asteroide ()
	...
	local novoAsteroide2 = display.newImageRect (mainGroup, player, 2, 90, 83)
	table.insert (asteroidsTable, novoAsteroide2 )
	physics.addBody (novoAsteroide2, "dynamic", {radius=40, bounce= 0.8} )
	novoAsteroide2.myName = "Asteróide2"

	local novoAsteroide3 = display.newImageRect (mainGroup, player, 3, 100, 97)
	table.insert (asteroidsTable, novoAsteroide3 )
	physics.addBody (novoAsteroide3, "dynamic", {radius=40, bounce= 0.8} )
	novoAsteroide3.myName = "Asteróide3"
